...
declare module '$env/static/private' {
	...
	export const CRATES_IO_TOKEN: string;
	export const GITHUB_PAT_DAVID: string;
	...
	export const HOSTINGER_VPS_ROOT_PASSWORD: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		LANGUAGE: string;
		NODE: string;
		CRATES_IO_TOKEN: string;
		GITHUB_PAT_DAVID: string;
		...
		NPM_TOKEN: string;
		HOSTINGER_VPS_ROOT_PASSWORD: string;
		OLDPWD: string;
